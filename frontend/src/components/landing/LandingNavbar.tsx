    ...
    >
      ...
      >
        ...
        {!loggedIn && (
          <Link
            href="/studio"
            className="landing-btn-primary flex items-center gap-1.5 rounded-xl px-3.5 py-1.5 text-xs font-semibold transition-transform duration-300 hover:translate-x-0.5"
            onClick={() => setOpen(false)}
          >
