    ...
    >
      ...
      >
        ...
        {!loggedIn && (
          <Link
            href="/studio"
            className="landing-btn-primary flex items-center gap-2 rounded-2xl px-4 py-2.5 text-sm font-semibold transition-transform duration-300 hover:translate-x-0.5"
            onClick={() => setOpen(false)}
          >
