            ...
            <div className="landing-pricing-card relative overflow-hidden rounded-[calc(1rem-2px)] p-8 sm:p-10">
              ...
              <div className="relative mt-8 text-center">
                ...
                <div className="mt-2 flex items-end justify-center gap-0.5">
                  <span
                    className="bg-gradient-to-br from-[var(--landing-fg)] to-landing-muted bg-clip-text pb-1 font-sans text-5xl font-bold leading-none text-transparent sm:text-6xl"
                    aria-hidden
                  >
                    ₹
                  </span>
                  <span className="bg-gradient-to-br from-[var(--landing-fg)] to-landing-muted bg-clip-text font-sans text-7xl font-bold tabular-nums leading-none tracking-tighter text-transparent sm:text-8xl">
                    0
                  </span>
                </div>
              ...
              <div className="relative mt-8 grid gap-3 sm:grid-cols-2">
                {INCLUDED.map(({ Icon, label, detail }, i) => (
                  <motion.div
                    key={label}
                    className="flex gap-3 rounded-xl border border-landing/80 bg-black/[0.03] p-3.5 dark:bg-white/[0.03]"
                  ...
                  >
                    ...
                    <div>
                      <p className="text-sm font-semibold text-[var(--landing-fg)]">{label}</p>
              ...
              <ul className="relative mt-6 space-y-2.5 border-t border-landing pt-6">
                {PERKS.map((p) => (
                  <li key={p} className="flex items-center gap-2.5 text-sm text-[var(--landing-fg)]">
              ...
              <div className="relative mt-8 flex flex-col gap-3 sm:flex-row">
                <Link
                  href="/studio"
                  className="landing-btn-primary group flex flex-1 items-center justify-center gap-2 rounded-xl py-3.5 text-base font-semibold"
                >
                  Open Studio
                ...
                <a
                  ...
                  className="flex flex-1 items-center justify-center gap-2 rounded-xl border border-landing py-3.5 text-base font-semibold text-[var(--landing-fg)] transition-colors hover:bg-landing-accent-muted"
                >
