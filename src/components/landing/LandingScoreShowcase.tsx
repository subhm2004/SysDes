  ...
  return (
    <div className="relative flex h-[148px] w-[148px] items-center justify-center sm:h-[168px] sm:w-[168px]">
      ...
      <div className="absolute flex flex-col items-center font-sans">
        <span className="text-5xl font-bold tabular-nums tracking-tight text-[var(--landing-fg)] sm:text-6xl">
          {score}
        </span>
      ...
      <div className="grid lg:grid-cols-[minmax(260px,320px)_1fr]">
        ...
        <div className="flex flex-col p-6 sm:p-8">
          <div className="flex items-start justify-between gap-4">
            <div>
              <h3 className="font-sans text-lg font-semibold tracking-tight text-[var(--landing-fg)] sm:text-xl">
                Five-axis breakdown
              </h3>
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div className="min-w-0 flex-1">
                    <div className="flex items-baseline justify-between gap-2">
                      <span className="text-sm font-semibold text-[var(--landing-fg)]">{a.name}</span>
                      <span className="font-mono text-sm font-bold tabular-nums text-[var(--landing-fg)]">{a.pct}</span>
                    </div>
                    ...
                    <div className="mt-2.5 h-2 overflow-hidden rounded-full bg-landing-accent-muted">
                      <motion.div
                        className={cn("h-full rounded-full bg-gradient-to-r", barTone(a.pct))}
          ...
          <div className="mt-8 flex flex-col gap-3 border-t border-landing pt-6 sm:flex-row sm:items-center sm:justify-between">
            <p className="text-sm text-landing-muted">
              <span className="font-medium text-[var(--landing-fg)]">86+</span> hits Architect band in the studio.
            </p>
            <Link
              href="/studio"
