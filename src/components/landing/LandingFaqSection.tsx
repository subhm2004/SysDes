  ...
  return (
    <motion.div
      className={cn(
        ...
        open
          ...
          : "border-landing bg-[var(--landing-surface)] hover:border-indigo-500/25 hover:bg-landing-accent-muted/50",
      )}
    ...
    >
      <button
        ...
        aria-expanded={open}
      >
        <span className="font-sans text-base font-semibold leading-snug text-[var(--landing-fg)] sm:text-lg">
          {question}
        </span>
        <span
          className={cn(
    ...
    <section id="faq" className="relative scroll-mt-28 overflow-hidden px-[5%] py-16 max-lg:px-4 sm:py-28">
      ...
      <div className="relative mx-auto max-w-3xl">
        ...
        >
          ...
          <h2 className="mt-3 font-sans text-4xl font-bold tracking-tight text-[var(--landing-fg)] max-md:text-3xl sm:text-5xl">
            Questions before{" "}
